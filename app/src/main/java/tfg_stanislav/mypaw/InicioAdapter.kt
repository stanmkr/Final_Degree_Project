...
import tfg_stanislav.mypaw.databinding.BannerItemBinding
import tfg_stanislav.mypaw.databinding.EachItemBinding

class InicioAdapter(private val dataItemList: List<DataItem>) :
